# -*- coding: utf-8 -*-
'''
GPU/CPU wrapper functions for sparse matrices, based on scikits.cuda
Licensed under GPL, version 2 or a later (see LICENSE.rst)

Note: this code re-uses code that originate from the scikits.cuda
project, which is Copyright (c) 2009-2014, Lev Givon. All rights reserved.

https://github.com/lebedov/scikits.cuda/blob/0ddb3d661f45ea2ca0f87efde49360df0a84fb22/docs/source/license.rst
for the scikits.cuda license terms.
'''
...
for k, v in _ffi_lib.__dict__.items():
